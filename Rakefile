# contents: Rakefile for the id3tag library.
#
...
spec =
  Gem::Specification.new do |s|
    ...
    s.has_rdoc = false
    s.extra_rdoc_files = []
    s.summary = 'libid3tag bindings'
    s.description = s.summary
    s.author = 'Nikolai Weibull'
    s.email = 'now@bitwi.se'
    s.homepage = 'http://git.bitwi.se/?p=ruby-id3tag.git;a=summary'
